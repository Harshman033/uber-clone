...
const VehiclePanel = ({ onDownArrowClick, setVehicle, pickUp, destination, setShowConfirmRidePanel }) => {
        ...
        <h3 className='font-semibold text-xl mb-4'>Choose a vehicle</h3>
            ...
            {vehicles.map(vehicle => (
              <div 
                ...
                onClick={() =>{setVehicle(vehicle); setShowConfirmRidePanel(true)}}
              >
                ...
                <h2 className='text-xl font-semibold pt-2'>${vehicle.price}</h2>
              </div>
            ))}
